...
class CategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_learning_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                DummyContent.ITEMS.observeForever { t ->
                    adapter = MyCategoryRecyclerViewAdapter(t, listener)
                }
            }
        }
        return view
...
//        }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: String?, index: Int?)
    }
